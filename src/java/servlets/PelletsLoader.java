...
public class PelletsLoader extends HttpServlet {
    String db_code;
    Statement state;
    ResultSet rs;
    String T, S, C, CO;
...
//        System.out.println("C: " + CO + " | nco: " + nco);
    ...
    private void getTeachers() {
        ...
        try {
            sql = "select name from teachers_"+db_code+"";
    ...
    private void getClassrooms() {
        ...
        try {
            sql = "select name from classrooms_"+db_code+"";
            rs = state.executeQuery(sql);
        ...
        try {
            sql = "select name from courses_"+db_code+"";
            rs = state.executeQuery(sql);
